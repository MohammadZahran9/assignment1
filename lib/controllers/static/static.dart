...
List<recommendedmode> listone = [
  ...
  recommendedmode(
      title: "Modren Leather Sofa", price: "\$200.00", image: imagesassets.two)
];
...
List<recentlymodel> listtwo = [
  recentlymodel(
      ...
      dis: "Chair",
      price: "\$130.00",
      image: imagesassets.three),
  recentlymodel(
      title: "Meridian Furniture\nChair",
      dis: "Chair",
      price: "\$180.00",
      image: imagesassets.four),
  recentlymodel(
      title: "Dining Chair With \nArms",
      dis: "Chair",
      price: "\$230.00",
      image: imagesassets.five),
];
